...
<p align="center">
  <img src="Git_Figures/Thermo_TN_Collection.png" width=70% height=70%>
  <br>
  <em>Figure 1: Tensor network representations for the thermodynamic rates of heat flux (a), chemical work (b), and the Renyi-2 entropy (c).</em>
</p>
